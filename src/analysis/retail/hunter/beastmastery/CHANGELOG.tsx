...
import { Putro, Arlie, Topple, SebShady, Vollmer, Kivlov, Jimache } from 'CONTRIBUTORS';
import { ResourceLink, SpellLink } from 'interface';
import TALENTS from 'common/TALENTS/hunter';
import SPELLS from 'common/SPELLS';
import RESOURCE_TYPES from 'game/RESOURCE_TYPES';
export default [
  change(date(2026, 2, 22), <>Enabled Beast Mastery hunter</>, Jimache),
  ...
  change(date(2023, 11, 21), <>Add `Call of the wild` to the spellbook specifying cooldown and global cooldown. </>, Putro),
  ...
  change(date(2022, 12, 16), 'Re-enable log parser.', Topple),
